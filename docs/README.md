...
4. **Troubleshooting**: [MONITORING.md](./MONITORING.md#troubleshooting) - Common issues and solutions
...
- **Component**: "Lambda Functions" | "API Gateway" | "Monitoring" | "CI/CD Pipeline"
